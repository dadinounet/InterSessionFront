    ...
    render() {
        return (
            <div className="left card">
                ...
                {this.isLogged ? <Link to={`/logout`}><LeftSideItem icon="exit_to_app" label="Logout" class="item"/></Link> : <Link to={`/login`}><LeftSideItem icon="input" label="Login" class={"item"}/></Link>}
